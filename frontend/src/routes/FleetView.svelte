...
<div class="max-w-7xl mx-auto px-4">
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
    ...
    {#each filteredFleet as system (system.id)}
      <button
        type="button"
        class="card w-full text-left bg-base-100 shadow-sm border border-base-200 hover:shadow-md hover:border-primary/40 transition-all duration-200 cursor-pointer group appearance-none"
